...
`));
  ...
  const _hoisted_1$b = { class: "mx-auto w-full bg-white p-1.5" };
  ...
  const settings = {
    enableDebugRules: !!_GM_getValue("debug-rules"),
    enableDebugFilter: !!_GM_getValue("debug-filters"),
...
e$2.toValue(firstParamTargets.value ? args[3] : args[2])
  ...
  const _hoisted_1$a = { class: "text-xl font-black text-white" };
...
onMove: (pos) => {
  ...
  const _hoisted_1$8 = { class: "mx-2 mb-2 flex flex-1 flex-col p-1 text-black" };
  const _sfc_main$c = e$2.defineComponent({
    ...
    setup(__props, { expose: __expose }) {
      ...
      __expose({ openEditor });
      return (_ctx, _cache) => {
        return isEditorShow.value ? (e$2.openBlock(), e$2.createBlock(_sfc_main$e, e$2.mergeProps({ key: 0 }, {
...
addShadowStyle(tag, className, css2) {
      ...
      if (curr) {
        ...
        this.cssStore.set(tag, new Set([{ className, css: css2 }]));
      }
        ...
        return e$2.withDirectives((e$2.openBlock(), e$2.createBlock(_sfc_main$e, e$2.mergeProps({
          ...
          default: e$2.withCtx(() => [
            (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(e$2.unref(currPageGroups), (group, index) => {
              return e$2.openBlock(), e$2.createElementBlock("div", { key: index }, [
                e$2.createVNode(_sfc_main$f, e$2.mergeProps({ ref_for: true }, { title: group.name, isFold: group.fold }), {
                  default: e$2.withCtx(() => [
                    (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(group.items, (item, innerIndex) => {
                      return e$2.openBlock(), e$2.createElementBlock("div", { key: innerIndex }, [
                        item.type === "switch" ? (e$2.openBlock(), e$2.createBlock(_sfc_main$7, e$2.mergeProps({
                          ...
                          key: 3,
                          ref_for: true
                        }, item, { onEdit: handleEdit }), null, 16)) : item.type === "list" ? (e$2.openBlock(), e$2.createBlock(_sfc_main$a, e$2.mergeProps({
                          key: 4,
                          ref_for: true
...
https://www.bilibili.com${location.pathname}`;
  ...
  const isWebScreen$1 = useThrottleFn(() => {
    return _unsafeWindow.player?.getManifest()?.screenKind === 2;
  }, 200);
  for (const eventName of ["mousewheel", "DOMMouseScroll", "wheel"]) {
    useEventListener(
      ...
      eventName,
      async (e2) => {
        if (preventVolumeTune$1 && await isWebScreen$1()) {
  ...
  const toggleFullScreen$1 = () => {
    ...
    switch (fullScreenStatus()) {
      case "ele":
        ...
        if (isWebScreen2()) {
          _unsafeWindow.player?.requestStatue(0);
        }
        break;
      case "f11":
        _unsafeWindow.player?.requestStatue(0);
      ...
      case "not":
        ...
        if (!isWebScreen2()) {
          _unsafeWindow.player?.requestStatue(2);
        }
        window.scrollTo(0, 0);
        break;
    }
...
getAll: (...args) => {
  ...
  e$2.watch(themeState, async (value) => {
...
https://${domain}/${avbv}` : `https://${domain}/${avbv}`;
          ...
          if (typeof _unsafeWindow.player?.requestStatue === "function") {
            _unsafeWindow.player.requestStatue(2).then(() => {
              ...
              const id2 = setInterval(() => {
                ...
                if (video && video.offsetWidth / innerWidth > 0.9 && video.offsetHeight / innerHeight > 0.9 && video.offsetHeight / innerHeight <= 1) {
                  clearInterval(id2);
  ...
  const _sfc_main$3 = e$2.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return e$2.withDirectives((e$2.openBlock(), e$2.createBlock(_sfc_main$e, e$2.mergeProps({ title: "bilibili 页面净化大师", widthPercent: 28, heightPercent: 85, minWidth: 360, minHeight: 600 }, {
          onClose: e$2.unref(store).hide
        }), {
          default: e$2.withCtx(() => [
              ...
              return e$2.createElementVNode("div", { key: i2 }, [
                (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(rule.groups, (group, j2) => {
                  return e$2.openBlock(), e$2.createElementBlock("div", { key: j2 }, [
                    e$2.createVNode(_sfc_main$f, e$2.mergeProps({ ref_for: true }, { title: group.name, isFold: group.fold, isSpecial: rule.isSpecial }), {
                      default: e$2.withCtx(() => [
                        (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(group.items, (item, innerIndex) => {
                          return e$2.openBlock(), e$2.createElementBlock("div", { key: innerIndex }, [
                            item.type === "switch" ? (e$2.openBlock(), e$2.createBlock(_sfc_main$7, e$2.mergeProps({
