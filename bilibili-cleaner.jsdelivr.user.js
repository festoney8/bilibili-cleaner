        ...
        dyns.forEach((v2) => {
          debugFilter(
            [
              ...
              `shortVideo: ${selectorFns$7.dynVideo(v2)}`,
              `playback: ${selectorFns$7.playback(v2)}`
            ].join("\n")
          );
        });
      }
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          saveFn: async () => {
            mainFilter$6.videoUploaderKeywordFilter.setParam(
              BiliCleanerStorage.get(GM_KEYS$6.black.uploaderKeyword.valueKey, [])
            );
            mainFilter$6.checkFull();
          }
        }
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          editorDescription: ["每行一个UP主昵称，保存时自动去重"],
          saveFn: async () => {
            mainFilter$6.videoUploaderWhiteFilter.setParam(
              BiliCleanerStorage.get(GM_KEYS$6.white.uploader.valueKey, [])
            );
            mainFilter$6.checkFull();
          }
        },
