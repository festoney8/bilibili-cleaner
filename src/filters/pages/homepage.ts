...
debug('keywordFilterInstance', homepageKeywordFilterStatus, globalKeywordFilterValue.length)
...
durationItems.push(new NumberItem(globalDurationFilterValueKey, '设定最低时长 (0~300s)', 60, 0, 300, '秒', undefined))
