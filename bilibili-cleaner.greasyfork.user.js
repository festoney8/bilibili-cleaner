...
`));
  ...
  const matchBvid = (s3) => {
    var _a;
    return ((_a = bvidPattern.exec(s3)) == null ? undefined : _a[1]) ?? null;
  };
  const avidbvidPattern = /(av\d+|BV[1-9A-HJ-NP-Za-km-z]+)/;
  const matchAvidBvid = (s3) => {
    var _a;
    return ((_a = avidbvidPattern.exec(s3)) == null ? undefined : _a[1]) ?? null;
  };
  ...
  const injectLocal = (...args) => {
    var _a;
    const key = args[0];
    const instance = (_a = e$1.getCurrentInstance()) == null ? undefined : _a.proxy;
  ...
  function useEventListener(...args) {
    ...
    const firstParamTargets = e$1.computed(() => {
      ...
      return test.every((e2) => typeof e2 !== "string") ? test : undefined;
    });
    const stopWatch = watchImmediate(
      () => {
        var _a, _b;
        return [
          (_b = (_a = firstParamTargets.value) == null ? undefined : _a.map((e2) => unrefElement(e2))) != null ? _b : [defaultWindow].filter((e2) => e2 != null),
  ...
  function useMagicKeys(options = {}) {
    ...
    function updateRefs(e2, value) {
      var _a, _b;
      const key = (_a = e2.key) == null ? undefined : _a.toLowerCase();
      const code = (_b = e2.code) == null ? undefined : _b.toLowerCase();
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        return e$1.openBlock(), e$1.createElementBlock(e$1.Fragment, null, [
          ...
          ((_a = _ctx.description) == null ? undefined : _a.length) ? (e$1.openBlock(), e$1.createBlock(_sfc_main$c, {
            key: 0,
            class: "pl-9",
            ...
            default: e$1.withCtx(() => {
              ...
              return [
                e$1.createElementVNode("div", _hoisted_3$2, [
                  ((_a2 = _ctx.editorDescription) == null ? undefined : _a2.length) ? (e$1.openBlock(), e$1.createBlock(_sfc_main$c, {
                    key: 0,
                    class: "mb-3",
  ...
  const _Shadow = class _Shadow {
    ...
    hook() {
      ...
      Element.prototype.attachShadow = function(init) {
        ...
        styles == null ? undefined : styles.forEach((v2) => {
      ...
      Object.defineProperty(ShadowRoot.prototype, "innerHTML", {
        ...
        set(value) {
          ...
          if (tagName && self2.cssStore.has(tagName)) {
            ...
            shadowStyles == null ? undefined : shadowStyles.forEach((v2) => {
    ...
    addShadowStyle(tag, className, css2) {
      ...
      if (this.shadowStore.size) {
        ...
        nodes == null ? undefined : nodes.forEach((node) => {
          const style = document.createElement("style");
  ...
  const selectorFns$7 = {
    root: {
      username: (comment) => {
        var _a, _b, _c;
        return (_c = (_b = (_a = comment.__data) == null ? undefined : _a.member) == null ? undefined : _b.uname) == null ? undefined : _c.trim();
      },
      content: (comment) => {
        var _a, _b, _c;
        return (_c = (_b = (_a = comment.__data) == null ? undefined : _a.content) == null ? undefined : _b.message) == null ? undefined : _c.replace(/@[^@\s]+/g, " ").trim();
      },
      callBot: (comment) => {
        var _a, _b;
        const members = (_b = (_a = comment.__data) == null ? undefined : _a.content) == null ? undefined : _b.members;
        if (members == null ? undefined : members.length) {
      ...
      callUser: (comment) => {
        var _a, _b, _c;
        return !!((_c = (_b = (_a = comment.__data) == null ? undefined : _a.content) == null ? undefined : _b.members) == null ? undefined : _c[0]);
      },
      callUserNoReply: (comment) => {
        var _a, _b, _c, _d;
        if (((_a = comment.__data) == null ? undefined : _a.rcount) !== 0) {
          return false;
        }
        return !!((_d = (_c = (_b = comment.__data) == null ? undefined : _b.content) == null ? undefined : _c.members) == null ? undefined : _d[0]);
      },
      ...
      callUserOnlyNoReply: (comment) => {
        ...
        return ((_d = (_c = (_b = comment.__data) == null ? undefined : _b.content) == null ? undefined : _c.message) == null ? undefined : _d.replace(/@[^@\s]+/g, " ").trim()) === "";
      },
      level: (comment) => {
        var _a, _b, _c;
        return (_c = (_b = (_a = comment.__data) == null ? undefined : _a.member) == null ? undefined : _b.level_info) == null ? undefined : _c.current_level;
      },
      isUp: (comment) => {
        var _a;
        const mid = (_a = comment.__data) == null ? undefined : _a.mid;
        const upMid = comment.__upMid;
        return typeof mid === "number" && mid === upMid;
      },
      isPin: (comment) => {
        var _a, _b;
        return !!((_b = (_a = comment.__data) == null ? undefined : _a.reply_control) == null ? undefined : _b.is_up_top);
      },
      isNote: (comment) => {
        var _a, _b;
        return !!((_b = (_a = comment.__data) == null ? undefined : _a.reply_control) == null ? undefined : _b.is_note_v2);
      },
      isLink: (comment) => {
        var _a, _b, _c, _d;
        const jump_url = (_b = (_a = comment.__data) == null ? undefined : _a.content) == null ? undefined : _b.jump_url;
        if (jump_url) {
          for (const k2 of Object.keys(jump_url)) {
            if (!((_d = (_c = jump_url[k2]) == null ? undefined : _c.pc_url) == null ? undefined : _d.includes("search.bilibili.com"))) {
              return true;
            }
          }
        }
      ...
      isMe: (comment) => {
        ...
        const me2 = (_a = comment.__user) == null ? undefined : _a.uname;
        if (!me2) {
          return false;
        }
        if (((_c = (_b = comment.__data) == null ? undefined : _b.member) == null ? undefined : _c.uname) === me2 || ((_f = (_e = (_d = comment.__data) == null ? undefined : _d.content) == null ? undefined : _e.message) == null ? undefined : _f.includes(`@${me2}`))) {
          return true;
        }
        return false;
      }
    ...
    sub: {
      ...
      content: (comment) => {
        var _a, _b, _c, _d, _e;
        return (_e = (_d = (_c = (_b = (_a = comment.__data) == null ? undefined : _a.content) == null ? undefined : _b.message) == null ? undefined : _c.trim()) == null ? undefined : _d.replace(/^回复\s?@[^@\s]+\s?:/, "")) == null ? undefined : _e.replace(/@[^@\s]+/g, " ").trim();
      },
      callBot: (comment) => {
        var _a, _b;
        const members = (_b = (_a = comment.__data) == null ? undefined : _a.content) == null ? undefined : _b.members;
      ...
      callUser: (comment) => {
        var _a, _b, _c, _d, _e;
        return !!((_e = (_d = (_c = (_b = (_a = comment.__data) == null ? undefined : _a.content) == null ? undefined : _b.message) == null ? undefined : _c.trim()) == null ? undefined : _d.replace(/^回复\s?@[^@\s]+\s?:/, "")) == null ? undefined : _e.match(/@[^@\s]+/));
      },
      callUserNoReply: (comment) => {
        var _a, _b, _c, _d, _e;
        return !!((_e = (_d = (_c = (_b = (_a = comment.__data) == null ? undefined : _a.content) == null ? undefined : _b.message) == null ? undefined : _c.trim()) == null ? undefined : _d.replace(/^回复\s?@[^@\s]+\s?:/, "")) == null ? undefined : _e.match(/@[^@\s]+/));
      ...
      isLink: (comment) => {
        var _a, _b, _c, _d;
        const urls = (_b = (_a = comment.__data) == null ? undefined : _a.content) == null ? undefined : _b.jump_url;
        if (urls) {
          for (const k2 of Object.keys(urls)) {
            if (!((_d = (_c = urls[k2]) == null ? undefined : _c.pc_url) == null ? undefined : _d.includes("search.bilibili.com"))) {
              return true;
            }
          }
        }
      ...
      isMe: (comment) => {
        ...
        if (((_c = (_b = comment.__data) == null ? undefined : _b.member) == null ? undefined : _c.uname) === me2 || ((_g = (_f = (_e = (_d = comment.__data) == null ? undefined : _d.content) == null ? undefined : _e.message) == null ? undefined : _f.trim()) == null ? undefined : _g.replace(/^回复\s?@[^@\s]+\s?:/, "").includes(`@${me2}`))) {
          return true;
        }
        return false;
      }
          ...
          enableFn: () => {
            fetchHook.addPostFn(
              async (input, init, resp) => {
                ...
                if (typeof input === "string" && ((_a = init == null ? undefined : init.method) == null ? undefined : _a.toUpperCase()) === "GET" && input.includes("api.bilibili.com/x/v2/reply/wbi/main")) {
                  try {
  ...
  const commentFilterCommonHandler = (target) => {
    ...
    const menus = [];
    if (((_a = target.parentElement) == null ? undefined : _a.id) === "user-name" || target.classList.contains("user-name") || target.classList.contains("sub-user-name")) {
      const username = (_b = target.textContent) == null ? undefined : _b.trim();
  ...
  const selectorFns$6 = {
    uploader: (dyn) => {
      ...
      return (_b = (_a = dyn.querySelector(".bili-dyn-title__text")) == null ? undefined : _a.textContent) == null ? undefined : _b.trim();
    },
    duration: (dyn) => {
      var _a, _b;
      const time = (_b = (_a = dyn.querySelector(".bili-dyn-card-video__cover-shadow .duration-time")) == null ? undefined : _a.textContent) == null ? undefined : _b.trim();
      return time ? convertTimeToSec(time) : undefined;
    },
    title: (dyn) => {
      var _a, _b;
      return (_b = (_a = dyn.querySelector(".bili-dyn-card-video__title")) == null ? undefined : _a.textContent) == null ? undefined : _b.trim();
    },
    content: (dyn) => {
      return Array.from(
        ...
        var _a;
        return (_a = v2 == null ? undefined : v2.textContent) == null ? undefined : _a.trim();
      }).filter((v2) => v2 == null ? undefined : v2.trim()).join(" ");
    }
  };
  ...
  const dynamicFilterDynamicHandler = (target) => {
    ...
    if (target.classList.contains("bili-dyn-title__text")) {
      const uploader = (_a = target.textContent) == null ? undefined : _a.trim();
  ...
  const selectorFns$5 = {
    duration: (video) => {
      var _a, _b;
      const duration = (_b = (_a = video.querySelector(".bili-video-card__stats__duration")) == null ? undefined : _a.textContent) == null ? undefined : _b.trim();
      return (duration && convertTimeToSec(duration)) ?? undefined;
    },
    title: (video) => {
      var _a, _b;
      return (_b = (_a = video.querySelector(".bili-video-card__info--tit a")) == null ? undefined : _a.textContent) == null ? undefined : _b.trim();
    },
    pubdate: (video) => {
      var _a, _b;
      const pubdate = (_b = (_a = video.querySelector(".bili-video-card__info--date")) == null ? undefined : _a.textContent) == null ? undefined : _b.trim();
      return pubdate && convertDateToDays(pubdate);
    },
    bvid: (video) => {
      var _a, _b;
      const href2 = ((_a = video.querySelector(".bili-video-card__info--tit a")) == null ? undefined : _a.getAttribute("href")) || ((_b = video.querySelector(".bili-video-card__image--link")) == null ? undefined : _b.getAttribute("href"));
      return (href2 && matchBvid(href2)) ?? undefined;
    },
    uploader: (video) => {
      var _a, _b;
      return (_b = (_a = video.querySelector(".bili-video-card__info--author")) == null ? undefined : _a.textContent) == null ? undefined : _b.trim();
    }
  };
  ...
  const videoFilterChannelHandler = (target) => {
    ...
    if (target.closest(".bili-video-card__info--owner")) {
      const uploader = (_c = (_b = (_a = target.closest(".bili-video-card__info--owner")) == null ? undefined : _a.querySelector(".bili-video-card__info--author")) == null ? undefined : _b.textContent) == null ? undefined : _c.trim();
      const url = (_d = target.closest(".bili-video-card__info--owner")) == null ? undefined : _d.href.trim();
      const spaceUrl = (_e = url == null ? undefined : url.match(/space\.bilibili\.com\/\d+/)) == null ? undefined : _e[0];
      if (uploader) {
    ...
    if (target instanceof HTMLAnchorElement && target.closest(".bili-video-card__info--tit")) {
      const url = (_g = (_f = target.closest(".bili-video-card__info--tit")) == null ? undefined : _f.querySelector("a")) == null ? undefined : _g.href;
  ...
  const selectorFns$4 = {
    ...
    views: (video) => {
      var _a, _b;
      const text = (_b = (_a = video.querySelector(".bili-video-card__stats--text")) == null ? undefined : _a.textContent) == null ? undefined : _b.trim();
      if (text) {
        if (/\d+(?:\.\d+)?万/.test(text)) {
    ...
    isFollow: (video) => {
      var _a, _b;
      return ((_b = (_a = video.querySelector(".bili-video-card__info--icon-text")) == null ? undefined : _a.textContent) == null ? undefined : _b.trim()) === "已关注";
    }
  };
  ...
  const getVideoData = (video) => {
    ...
    if (!video.classList.contains("rank-item")) {
      return (_a = video.__vue__) == null ? undefined : _a.videoData;
    }
    const rank = video.getAttribute("data-rank");
    if (rank && parseInt(rank) > 0) {
      videoData = (_d = (_c = (_b = video.closest(".rank-list-wrap")) == null ? undefined : _b.__vue__) == null ? undefined : _c.list) == null ? undefined : _d[parseInt(rank) - 1];
    }
    return videoData;
  };
  const selectorFns$3 = {
    title: (video) => {
      var _a;
      return (_a = getVideoData(video)) == null ? undefined : _a.title;
    },
    bvid: (video) => {
      var _a;
      return (_a = getVideoData(video)) == null ? undefined : _a.bvid;
    },
    uploader: (video) => {
      var _a, _b;
      return (_b = (_a = getVideoData(video)) == null ? undefined : _a.owner) == null ? undefined : _b.name;
    },
    duration: (video) => {
      var _a;
      return (_a = getVideoData(video)) == null ? undefined : _a.duration;
    },
    quality: (video) => {
      var _a;
      const stat = (_a = getVideoData(video)) == null ? undefined : _a.stat;
    ...
    dimension: (video) => {
      var _a;
      const dimension = (_a = getVideoData(video)) == null ? undefined : _a.dimension;
      if (dimension && typeof dimension.height === "number" && typeof dimension.width === "number") {
        return (dimension == null ? undefined : dimension.height) > (dimension == null ? undefined : dimension.width);
      }
      return undefined;
    }
  };
  ...
  const videoFilterPopularHandler = (target) => {
    ...
    if (target.classList.contains("title") && target.closest(".info a") || target.classList.contains("video-name") || target.classList.contains("lazy-image")) {
      let url = target.getAttribute("href") || ((_b = target.parentElement) == null ? undefined : _b.getAttribute("href"));
      if (!url) {
        url = (_d = (_c = target.closest(".video-card")) == null ? undefined : _c.querySelector(".video-card__content > a")) == null ? undefined : _d.getAttribute("href");
      }
  ...
  const selectorFns$2 = {
    ...
    title: (video) => {
      var _a, _b;
      return (_b = (_a = video.querySelector(".bili-video-card__info--tit")) == null ? undefined : _a.textContent) == null ? undefined : _b.trim();
    },
    bvid: (video) => {
      var _a, _b;
      const href2 = ((_a = video.querySelector(".bili-video-card__wrap > a")) == null ? undefined : _a.getAttribute("href")) || ((_b = video.querySelector(".bili-video-card__info--right > a")) == null ? undefined : _b.getAttribute("href"));
      return (href2 && matchBvid(href2)) ?? undefined;
    },
    uploader: (video) => {
      var _a, _b;
  ...
  const videoFilterSearchHandler = (target) => {
    ...
    if (target.classList.contains("bili-video-card__info--tit")) {
      const url = (_f = target.parentNode) == null ? undefined : _f.href;
  ...
  const selectorFns$1 = {
    duration: (video) => {
      var _a, _b, _c, _d;
      const duration = ((_b = (_a = video.querySelector("span.length")) == null ? undefined : _a.textContent) == null ? undefined : _b.trim()) || ((_d = (_c = video.querySelector(".bili-cover-card__stats .bili-cover-card__stat:nth-last-child(1)")) == null ? undefined : _c.textContent) == null ? undefined : _d.trim());
      return (duration && convertTimeToSec(duration)) ?? undefined;
    },
    title: (video) => {
      var _a, _b, _c, _d;
      return ((_b = (_a = video.querySelector("a.title")) == null ? undefined : _a.textContent) == null ? undefined : _b.trim()) || ((_d = (_c = video.querySelector(".bili-video-card__title a")) == null ? undefined : _c.textContent) == null ? undefined : _d.trim());
    },
    bvid: (video) => {
      var _a, _b, _c, _d;
      const href2 = ((_b = (_a = video.querySelector("a.title")) == null ? undefined : _a.getAttribute("href")) == null ? undefined : _b.trim()) || ((_d = (_c = video.querySelector(".bili-video-card__title a")) == null ? undefined : _c.getAttribute("href")) == null ? undefined : _d.trim());
      return (href2 && matchBvid(href2)) ?? undefined;
    }
  };
  ...
  const selectorFns = {
    duration: (video) => {
      var _a;
      const duration = (_a = video.querySelector(".pic-box span.duration")) == null ? undefined : _a.textContent;
      return duration ? convertTimeToSec(duration) : undefined;
    },
    title: (video) => {
      var _a, _b;
      return (_b = (_a = video.querySelector(".info > a p")) == null ? undefined : _a.textContent) == null ? undefined : _b.trim();
    },
    bvid: (video) => {
      var _a, _b;
      const href2 = ((_a = video.querySelector(".info > a")) == null ? undefined : _a.getAttribute("href")) || ((_b = video.querySelector(".pic-box .framepreview-box > a")) == null ? undefined : _b.getAttribute("href"));
      return (href2 && matchBvid(href2)) ?? undefined;
    },
    uploader: (video) => {
      var _a, _b;
      return (_b = (_a = video.querySelector(".info > .upname .name")) == null ? undefined : _a.textContent) == null ? undefined : _b.trim();
    }
  };
    ...
    async check(mode) {
      ...
      if (enableRelatedCheck && blackCnt) {
        ...
        for (const video of videos) {
          if (isEleHide(video)) {
            const url = (_a = video.querySelector(".info > a")) == null ? undefined : _a.getAttribute("href");
            if (url) {
              const bvid = matchBvid(url);
        ...
        const rel = (_b = _unsafeWindow.__INITIAL_STATE__) == null ? undefined : _b.related;
        if ((rel == null ? undefined : rel.length) && blackBvids.size) {
  ...
  const videoFilterVideoHandler = (target) => {
    ...
    const menus = [];
    if (target.classList.contains("name") || target.classList.contains("up-name") || ((_a = target.parentElement) == null ? undefined : _a.classList.contains("up-name")) || target.closest(".staff-info")) {
      const uploader = ((_d = (_c = (_b = target.closest(".staff-info")) == null ? undefined : _b.querySelector(".staff-name")) == null ? undefined : _c.textContent) == null ? undefined : _d.trim()) || ((_e = target.textContent) == null ? undefined : _e.trim()) || ((_g = (_f = target.parentElement) == null ? undefined : _f.textContent) == null ? undefined : _g.trim());
      const url = (_i = (_h = target.closest(".upname")) == null ? undefined : _h.querySelector(":scope a")) == null ? undefined : _i.getAttribute("href");
      const spaceUrl = (_j = url == null ? undefined : url.match(/space\.bilibili\.com\/\d+/)) == null ? undefined : _j[0];
      if (uploader) {
    ...
    if (target.classList.contains("title")) {
      const url = (_k = target.parentElement) == null ? undefined : _k.getAttribute("href");
    ...
    setup(__props) {
      ...
      useEventListener(window, "contextmenu", (e2) => {
        ...
        if (e2.target instanceof HTMLElement) {
          const target = (_a = e2.composedPath()) == null ? undefined : _a[0];
          ...
          (e$1.openBlock(true), e$1.createElementBlock(e$1.Fragment, null, e$1.renderList(menuList.value, (menu2, index) => {
            return e$1.openBlock(), e$1.createElementBlock("div", { key: index }, [
              e$1.createElementVNode("div", {
                onClick: ($event) => {
                  var _a;
                  return (_a = menu2.fn()) == null ? undefined : _a.then().catch();
                },
        ...
        const id = setInterval(() => {
          ...
          if (shareBtn) {
            ...
            shareBtn.addEventListener("click", () => {
              var _a, _b;
              const mainTitle = (_a = document.querySelector("[class^='mediainfo_mediaTitle']")) == null ? undefined : _a.textContent;
              const subTitle = (_b = document.getElementById("player-title")) == null ? undefined : _b.textContent;
  ...
  const bangumiPlayerLayoutItems = [
    {
      ...
      enableFn: () => {
        ...
        if ((_g = (_f = (_e = (_d = (_c = (_b = (_a = origNextData == null ? undefined : origNextData.props) == null ? undefined : _a.pageProps) == null ? undefined : _b.dehydratedState) == null ? undefined : _c.queries) == null ? undefined : _d[1]) == null ? undefined : _e.state) == null ? undefined : _f.data) == null ? undefined : _g.show) {
        ...
        Object.defineProperty(_unsafeWindow, "__NEXT_DATA__", {
          ...
          set(value) {
            ...
            if ((_g2 = (_f2 = (_e2 = (_d2 = (_c2 = (_b2 = (_a2 = value.props) == null ? undefined : _a2.pageProps) == null ? undefined : _b2.dehydratedState) == null ? undefined : _c2.queries) == null ? undefined : _d2[1]) == null ? undefined : _e2.state) == null ? undefined : _f2.data) == null ? undefined : _g2.show) {
      ...
      enableFn: async () => {
        ...
        const id = setInterval(() => {
          ...
          if (webBtn && fullBtn) {
            ...
            (_a = fullBtn.parentElement) == null ? undefined : _a.replaceChild(newFullBtn, fullBtn);
          } else {
            cnt++;
      ...
      enableFn: async () => {
        ...
        if (coinBtn) {
          ...
          document.addEventListener("DOMContentLoaded", () => {
            ...
            coinBtn2 == null ? undefined : coinBtn2.addEventListener("click", disableAutoLike);
          });
        }
      }
    },
    ...
    },
    {
      ...
      enableFn: () => {
        fetchHook.addPreFn((input, init) => {
          var _a;
          if (typeof input === "string" && input.includes("api.bilibili.com") && input.includes("feed/rcmd") && ((_a = init == null ? undefined : init.method) == null ? undefined : _a.toUpperCase()) === "GET") {
    ...
    },
    {
      ...
      enableFn: async () => {
        ...
        document.addEventListener("DOMContentLoaded", () => {
          ...
          const id = setInterval(() => {
            var _a, _b;
            const player = _unsafeWindow.livePlayer || ((_a = _unsafeWindow.EmbedPlayer) == null ? undefined : _a.instance);
            const status = (_b = player == null ? undefined : player.getPlayerInfo()) == null ? undefined : _b.playerStatus;
            if (player && status === 0) {
              requestAnimationFrame(() => {
  ...
  const spaceBasicItems = [
    {
      ...
      enableFn: () => {
        var _a;
        if (/\/\d+\/?($|\?)/.test(location.pathname)) {
          const userid = (_a = location.pathname.match(/\d+/)) == null ? undefined : _a[0];
          if (userid) {
      ...
      if (isPageVideo() || isPagePlaylist()) {
        ...
        Object.defineProperty(_unsafeWindow, "isWide", {
          ...
          set: (value) => {
            ...
            if (_isWide) {
              (_a = document.documentElement) == null ? undefined : _a.setAttribute("player-is-wide", "");
            } else {
              (_b = document.documentElement) == null ? undefined : _b.removeAttribute("player-is-wide");
            }
          }
        });
      }
