...
// @require      https://registry.npmmirror.com/vue/3.5.32/files/dist/vue.global.prod.js
        ...
        const id = setInterval(() => {
          ...
          if (shareBtn) {
            shareBtn.addEventListener("click", () => {
              ...
              const prefix = (_b = document.querySelector("#categoryPill")) == null ? void 0 : _b.textContent;
